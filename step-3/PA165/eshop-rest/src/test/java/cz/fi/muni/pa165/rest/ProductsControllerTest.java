...
public class ProductsControllerTest extends AbstractTestNGSpringContextTests {
    ...
    public void debugTest() throws Exception {
        doReturn(Collections.unmodifiableList(this.createProducts()))
                .when(productFacade)
                .getAllProducts();
    ...
    public void createProduct() throws Exception {
        ...
        mockMvc.perform(post("/products/create").contentType(MediaType.APPLICATION_JSON).content(json))
                .andDo(print())
                .andExpect(status().isOk());
    }
    ...
    public void addCategory() throws Exception {
        ...
        mockMvc.perform(post("/products/1/categories").contentType(MediaType.APPLICATION_JSON).content(json))
                .andDo(print())
                .andExpect(status().isOk());
    }
    ...
    public void getNonExistingProduct() throws Exception {
        doThrow(ResourceNotFoundException.class).when(productFacade).getProductWithId(-1l);
