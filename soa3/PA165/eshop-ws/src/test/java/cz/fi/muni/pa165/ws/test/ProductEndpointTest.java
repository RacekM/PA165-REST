...
public class ProductEndpointTest extends AbstractTestNGSpringContextTests {
    ...
    @Test
    public void invalidProductRequestTest(){
        doReturn(null).when(productRepository).getProductByName("Invalid product");
        ...
        mockClient.sendRequest(withPayload(request)).andExpect(serverOrReceiverFault("Product not found."));
    }
    ...
    public void getAllProductsTest(){
        ...
        mockClient.sendRequest(withPayload(request)).andExpect(payload(responsePayload));
